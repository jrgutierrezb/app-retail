...
@Component({
  selector: 'app-denied-proform-request',
  templateUrl: './denied-proform-request.component.html',
  styleUrls: ['./denied-proform-request.component.css']
})
export class DeniedProformRequestComponent implements OnInit {
  ...
  buildForm() {
    return new FormGroup({
      ...
      useriddeniedproform:  new FormControl(this.currentUserId, [Validators.required]),
      deniedproformobservation: new FormControl(this.assetRequest ? this.assetRequest.deniedproformobservation : '', [Validators.required]),
  ...
  save() {
    ...
    let request: IAssetRequest = {
      ...
      useriddeniedproform: this.form.get('useriddeniedproform').value,
      deniedproformobservation: this.form.get('deniedproformobservation').value,
    ...
    this.DeniedProformAssetRequest(request).subscribe(
      (respuesta) => {
        if(!respuesta.error) {
  ...
  DeniedProformAssetRequest(assetRequest:  IAssetRequest): Observable<BaseResponse> {
    return this.assetRequestService.DeniedProformAssetRequest(assetRequest);
  }
